...
def _plot_board_state(
    ...
    ax.plot(2, 1,'o',markersize=10, markeredgecolor=(.5,.5,.5), markerfacecolor='k', markeredgewidth=2)
...
def plot_go_state(file_path: str):
    ...
    if os.path.exists(dir_name):
        ...
        os.mkdir(dir_name)
    _plot_board_state(board_info['state'], board_info['ground_truth'], board_info['turn'], board_info['board_size'][0], dir_name)
